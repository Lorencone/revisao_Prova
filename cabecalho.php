    ...
    <div id="left-menu">
        <div class="sub-left-menu scroll">
            <ul class="nav nav-list">
                ...
                <li class="time">
                    <h1 class="animated fadeInLeft">21:49</h1>
                    <p class="animated fadeInRight">Sat,October 1st 2029</p>
                </li>
                <li class="active ripple">
                    <a class="nav-header"  href="../produto/index.php"><span class="fa fa-check-square"></span> Produto</a>
                </li>
                <li class="ripple">
                    <a class="nav-header"  href="../modelo/index.php"><span class="fa fa-users"></span> Modelo</a>
                </li>
                <li class="ripple">
